...
def splitzone(trainfile, CatBoostsave, depth, month,remarknote,Predict_features, num_features):
    ...
    RandomForestModel(dataset, CatBoostsave, depth, month,remarknote, 999, Predict_features,num_features)
    del dataset

def RandomForestModel(dataset, RandomForestSave, depth, month,remarknote, temp_classinformation,Predict_features,num_features):# 随机森林回归建模
    # 数据准备
