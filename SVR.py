...
def splitzone(trainfile, CatBoostsave, depth, month,remarknote,Predict_features, num_features):
    ...
    for temp_classinformation in sorted_list:
        ...
        total_MSE, total_MAE, total_MAPE, total_R2,total_test,total_pre = SVRModel(temp_data, CatBoostsave, temp_classinformation, Predict_features,num_features, total_MSE, total_MAE, total_MAPE, total_R2,total_test,total_pre)
        del temp_data
        gc.collect()
...
def SVRModel(dataset, SVRSave, temp_classinformation,Predict_features,num_features, total_MSE, total_MAE, total_MAPE, total_R2,total_test,total_pre):
    # 数据准备
    datfile = SVRSave
    ...
    del y_train
    del y_test
    return total_MSE, total_MAE, total_MAPE, total_R2,total_test,total_pre
    gc.collect()
